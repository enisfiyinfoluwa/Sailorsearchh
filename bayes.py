...
class Search():
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob):
        ...
        local_y_range = range(area_array.shape[0])       ## MINE: Why use [0] exactly ?
    ...
    def revise_target_probs(self):
        ...
        p2 = 0.5
        p3 = 0.3
       # print("P1 = {:.3f}, P2 = {:.3f}, P3 = {:.3f}".format(p1,p2,p3))
        ...
        denom = p1 * (1 - self.sep1) + p2 * (1 - self.sep2) \
                + p3 * (1 - self.sep3)
        p1 = p1 * (1 - self.sep1) / denom
        p2 = p2 * (1 - self.sep2) / denom
        p3 = p3 * (1 - self.sep3) / denom
...
def main():
    ...
    # # Test if we can decouple p1 from global variable
    #
    p1,p2,p3 = app.revise_target_probs()
    print("P1 = {:.3f}, P2 = {:.3f}, P3 = {:.3f}".format(p1, p2, p3))



#### Uncomment next line above reads error !!!!!!!!!!!!
